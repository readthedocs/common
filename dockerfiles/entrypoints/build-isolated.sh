...
CMD="$VENV/bin/celery -A worker.celery worker --loglevel=INFO --concurrency=1 --max-tasks-per-child=1 --without-mingle --without-gossip --without-heartbeat -Q ${RTD_BUILDS_QUEUE}"
